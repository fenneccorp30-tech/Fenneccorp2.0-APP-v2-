          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="font-bold text-lg mb-1">{aboutData.cultureTitle}</h4>
                  <p className="text-gray-500">{aboutData.cultureDesc}</p>
                </div>
              </div>
              <div className="flex gap-6">
                <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center shadow-sm shrink-0">
                ...
                <div>
                  <h4 className="font-bold text-lg mb-1">{aboutData.qualityTitle}</h4>
                  <p className="text-gray-500">{aboutData.qualityDesc}</p>
                </div>
              </div>
            </div>
          </div>
